...
class GoogleAuthenticator extends OAuth2Authenticator
{
    ...
    private ManagerRegistry $doctirne;
        ...
        return new SelfValidatingPassport(
            new UserBadge($accessToken->getToken(), function () use ($accessToken, $client) {
                ...
                if (!$existingUser) {
                    ...
                    $existingUser->setPhoto($googleUser->getAvatar());
                    $existingUser->setVille($googleUser->getLocale());
                    $existingUser->setPassword(' ');
                    $existingUser->setRoles(['ROLE_CLIENT']);
                    $existingUser->setIsPartner(false);
                    $existingUser->setIsGoogle(true);
